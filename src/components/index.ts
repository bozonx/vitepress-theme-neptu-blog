...
export { default as Authors } from './utility/Authors.vue'
...
export { default as Years } from './utility/Years.vue'
...
export { tobiiLightboxPlugin } from './doc-components/tobiiLightboxPlugin.ts'
